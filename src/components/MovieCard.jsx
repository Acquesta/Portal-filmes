    ...
    return (
        <>
            <Link className="my-3 rounded-xl text-black font-bold" to={`/movies/${id}`}>
                <div className="min-w-[20vw] cursor-pointer">
                    <img className="h-[30vw] w-auto hover:scale-105 transition-all rounded-xl" src={`https://image.tmdb.org/t/p/w500${poster_path}`} alt="imagem não encontrada"/>
